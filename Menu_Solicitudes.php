		...
		<div id="Content">
			<div id="path"></div>
				<div id="inicio">
					...
					<a href="Pdf_Solicitudes.php">
    				<img src="./Control_Mantenimiento_Infraestructura_files/Img/Solicitudes_Registradas.png" style="position: absolute; left: 1px; top: 300px;" width="250" height="80" alt="Menú Solicitudes" title="Click para consultar las solicitudes registradas"></img>
					</a>
					
					<a href="Enviar_Formato_Solicitud_Administrativo.php">
    				<img src="./Control_Mantenimiento_Infraestructura_files/Img/Enviar_Formato_Solicitud.png" style="position: absolute; left: 365px; top: 300px;" width="250" height="80" alt="Menú Formato De Solicitud" title="Click para diligenciar y enviar el formato de solicitud de mantenimiento"></img>
					</a>
