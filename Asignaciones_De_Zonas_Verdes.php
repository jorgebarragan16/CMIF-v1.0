	...
	<div id="Container">
			...
			<div align="center">
				...
				<div id="migas">
					<ul id="breadcrumbs-one">
						...
						<li><a href="Asignaciones_De_Zonas_Verdes.php">Mantenimiento En Zonas Verdes</a></li>
					</ul>
				</div>
			</div>
		</div>
		...
		<div id="Content">
			...
			<div id="inicio">
				...
				<h1>Realizar Asignacion Zonas Verdes</h1>
				<div class="inset">									
				<?php
					include ("ConexionBD.php");
					$result = mysql_query ( "Select * from solicitud where Tipo_Mantenimiento = 'Zonas Verdes' AND Id_Solicitud NOT IN (SELECT Solicitud_Id_Solicitud FROM `asignacion`)", $link );
				?> 
						<p>
			 	 ...
			 	 <?php
					include ("ConexionBD.php");
					$result = mysql_query ( "SELECT Id_Contratista, Nombres_Contratista, Primer_Apellido_Contratista, Segundo_Apellido_Contratista FROM contratista WHERE Especialidad_Contratista = 'Zonas Verdes'", $link );
				 ?> 
						<p>
