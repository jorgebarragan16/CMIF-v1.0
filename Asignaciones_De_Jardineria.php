			...
			<div align="center">
				...
				<div id="migas">
					<ul id="breadcrumbs-one">
						...
						<li><a href="Asignaciones_De_Jardineria.php">Mantenimientos De Jardinería</a></li>
					</ul>
				</div>
			</div>
		</div>
		...
		<div id="Content">
			...
			<div id="inicio">
				...
				<form method="post" action="Validar_Asignacion.php" style="position: absolute; left: 410px; top: 320px;">
					<h1>Realizar Asignacion De Jardinería</h1>
					<div class="inset">								
					<?php
						include ("ConexionBD.php");
						$result = mysql_query ( "Select * from solicitud where Tipo_Mantenimiento = 'Jardineria' AND Id_Solicitud NOT IN (SELECT Solicitud_Id_Solicitud FROM `asignacion`)", $link );
					?> 
						<p>
			 	 	...
			 	 	<?php
						include ("ConexionBD.php");
						$result = mysql_query ( "SELECT Id_Contratista, Nombres_Contratista, Primer_Apellido_Contratista, Segundo_Apellido_Contratista FROM contratista WHERE Especialidad_Contratista = 'Jardineria'", $link );
					?> 
						<p>
