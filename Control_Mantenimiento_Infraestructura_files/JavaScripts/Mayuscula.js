var capslock = {
		...
		show_warning: function(targ) {
			if (!targ.warning) {
				...
				targ.warning.src = "./Control_Mantenimiento_Infraestructura_files/Img/Alerta.png";
				targ.warning.style.position = "absolute";
				targ.warning.style.top = (targ.offsetTop + 85) + "px";
				targ.warning.style.left = (targ.offsetLeft + targ.offsetWidth + 470) + "px";
				targ.warning.style.zIndex = "999";
				targ.warning.setAttribute("alt", "Alerta, La tecla BLOQ MAYUS esta activada");
				if (targ.warning.runtimeStyle) {
					// PNG transparency for IE
					targ.warning.runtimeStyle.filter += "progid:DXImageTransform.Microsoft.AlphaImageLoader(src='./Control_Mantenimiento_Infraestructura_files/Alerta.png',sizingMethod='scale')";
				}
