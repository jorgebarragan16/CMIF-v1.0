			...
			<div align="center">
				...
				<div id="migas">
						<ul id="breadcrumbs-one">
    						...
    						<li><a href="Menu_Informacion.php">Menú Información</a></li>
						</ul>
				</div>
			</div>
		</div>
		...
		<div id="Content">
			<div id="path"></div>
				<div id="inicio">
					...
					<a href="Pdf_Codigos_Mantenimiento.php">
    				<img src="./Control_Mantenimiento_Infraestructura_files/Img/Codigos_Mantenimiento.png" style="position: absolute; left: 1px; top: 300px;" width="250" height="80" alt="Menú De Información" title="Click para consultar los codigos de los mantenimientos"></img>
					</a>
					
					<a href="Pdf_Codigos_Sitio.php">
    				<img src="./Control_Mantenimiento_Infraestructura_files/Img/Codigos_Sitios.png" style="position: absolute; left: 365px; top: 300px;" width="250" height="80" alt="Menú Contratistas" title="Click para consultar los codigos para los sitios de mantenimiento"></img>
					</a>
