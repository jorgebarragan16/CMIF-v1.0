		...
		<div id="Content">
			<div id="path"></div>
				<div id="inicio">
					...
					<a href="Pdf_Contratistas.php">
    				<img src="./Control_Mantenimiento_Infraestructura_files/Img/Datos_Contratista.png" style="position: absolute; left: 1px; top: 300px;" width="250" height="80" alt="Menú De Información" title="Click para consultar los datos personales de los contratistas / operarios registrados"></img>
					</a>
					
					<a href="Pdf_Contratistas_Especialidad.php">
    				<img src="./Control_Mantenimiento_Infraestructura_files/Img/Total_Contratista.png" style="position: absolute; left: 365px; top: 300px;" width="250" height="80" alt="Menú Contratistas" title="Click para consultar la cantidad de contratista / operarios por especialidad"></img>
					</a>
					
					<a href="Registro_Contratistas.php">
    				<img src="./Control_Mantenimiento_Infraestructura_files/Img/Registrar_Contratista.png" style="position: absolute; left: 735px; top: 300px;" width="250" height="80" alt="Menú Contratistas" title="Click para registrar a un nuevo contratista / operario"></img>
					</a>
					
					<a href="Pagina_Principal_Administrativo.php">
    				<img src="./Control_Mantenimiento_Infraestructura_files/Img/Volver.png" style="position: absolute; left: 1px; top: 420px;" width="250" height="80" alt="Menú Contratistas" title="Click para regresar a la página principal"></img>
					</a>
					
					<a href="Salir.php" onclick="return confirm('Seguro que quiere cerrar sesión?')">
					<img src="./Control_Mantenimiento_Infraestructura_files/Img/Cerrar_Sesion.png" style="position: absolute; left: 365px; top: 450px;" width="250" height="50" alt="Cerrar Sesion" title="Click para finalizar la sesión"></img>
					</a>
 	 			</div>
