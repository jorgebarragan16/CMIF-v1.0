			...
			<div align="center">
				...
				<div id="migas">
						<ul id="breadcrumbs-one">
    						...
    						<li><a href="Menu_Cambiar_Contrasena.php">Menú Actualizar Contraseña</a></li>
						</ul>
				</div>
			</div>
		</div>
			...
			<div id="path"></div>
				<div id="inicio">
					...
					<div>
                        ...
                        <h1> Actualizar Contraseña Contratista</h1>
                        	<div class="inset">
                                <p> 
                                    <label for="passwordsignup" class="youpasswd" data-icon="p">Digite la nueva Contraseña </label>
                                    <input id="passwordsignup" name="Pass_Contratista1" required="required" autofocus type="password" placeholder="Ingrese la nueva contraseña"></input>
                                </p>
                                
                                <p> 
                                    <label for="passwordsignup" class="youpasswd" data-icon="p">Confirme la nueva Contraseña </label>
                                    <input id="passwordsignup" name="Pass_Contratista2" required="required" type="password" placeholder="Ingrese la nueva contraseña"></input>
                                </p>
                             </div>             
