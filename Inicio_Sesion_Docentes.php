...
{
	$nick_d = $_POST['Nick_Usuario'];
	$pass_d = $_POST['Pass_Usuario'];
	$fields = 	$arrayName = array('usuario' => $nick_d, 'clave' => $pass_d);
	foreach($fields as $key=>$value) { $fields_string .= $key.'='.$value.'&'; }
	rtrim($fields_string, '&');

	$url = "http://ryca.itfip.edu.co:8888/profesor/login?". $fields_string;
	//open connection
	$ch = curl_init();
