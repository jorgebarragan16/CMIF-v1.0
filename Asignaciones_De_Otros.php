	...
	<div id="Container">
			...
			<div align="center">
				...
				<div id="migas">
					<ul id="breadcrumbs-one">
						...
						<li><a href="Asignaciones_De_Otros.php">Mantenimientos De Otro Tipo</a></li>
					</ul>
				</div>
			</div>
		</div>
		...
		<div id="Content">
			...
			<div id="inicio">
				...
				<h1>Realizar Asignacion Otros Mantenimientos</h1>
				<div class="inset">													
				<?php
					include ("ConexionBD.php");
					$result = mysql_query ( "Select * from solicitud where Tipo_Mantenimiento = 'Otro' AND Id_Solicitud NOT IN (SELECT Solicitud_Id_Solicitud FROM `asignacion`)", $link );
				?> 
					<p>
			 	...
			 	<?php
					include ("ConexionBD.php");
					$result = mysql_query ( "SELECT Id_Contratista, Nombres_Contratista, Primer_Apellido_Contratista, Segundo_Apellido_Contratista FROM contratista", $link );
				?> 
					<p>
